 ...
 * @endcode
 */
$settings['hash_salt'] = 'a6GgwRjH1kvDPDP23kV8Je1liCX01aMzOjceqxd3DsmA7sJozJZ1mwr3HB107m10sJwGlJwmtg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8lesson_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_d8lesson_dd.inc';
}
// </DDSETTINGS>
$databases['default']['default'] = array (
  'database' => 'd8lesson',
